...
\[ \implies  \prob{A} = \sum_{i=1}^{n} \prob{A \mid B_i} \cdot \prob{B_i} \]
...
Calcoliamo, come prima $ \p{R} = 0.005 \cdot \dfrac{1}{6} + 0.2 \cdot \dfrac{2}{3} + 0.7 \cdot \dfrac{1}{6} \approx 0.25 $
